...
public class GameWindow {
    ...
    /**
     * Display the scores scene, using the final game state.
     * @param game Game that has finished and contains the final score.
     */
    ...
    public void showLobby() {
        logger.info("Loading Multiplayer Lobby");
    ...
    public void startMultiplayerGame() {
        logger.info("Loading Multiplayer Challenge");
        loadScene(new MultiplayerScene(this, communicator));
    }

    /**
     * Display the game's settings
     */
    ...
    public void loadScene(BaseScene newScene) {
        ...
        logger.info("Preparing to initialise "+currentScene.getClass());
